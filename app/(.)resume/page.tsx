            ...
            <div className="my-8 flex flex-col gap-3">
              ...
              <div className="font-medium text-sm flex flex-col mx-10">
                <ul className="list-disc flex flex-col gap-1">
                  <li>
                    <span className="font-black">General:</span> JavaScript/TypeScript, Python,
                    Jira.
                  </li>
                  <li>
                  ...
                  <li>
                    <span className="font-black">Backend:</span> Node + Express, Django, SQL -
                    NoSQL, worked with Postgres + PlanetScale, Prisma ORM.
                  </li>
